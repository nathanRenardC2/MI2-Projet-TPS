...
for(let i = 0; i < menu.length; i++){
  ...
  // Listener au clic sur le menu hamburger
  ...
  // Listener sur la fenêtre pour fermer le menu si la taille de la fenêtre est supérieure à 1024px
  window.addEventListener("resize", function(){
    if(window.innerWidth > 1024){
      menus.style.display = "flex";
      menus_open = true;
